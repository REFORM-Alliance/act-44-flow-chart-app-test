  ...
  list(
    ...
    content_below_buttons = 
      tags$div(
        ...
        # tags$img(src = "act-44-early-termination-flow-chart.png", height = "200px", style = "display: block; margin: 20px auto;"),
        # tags$a(
        #   href = "act-44-early-termination-flow-chart.png", 
        #   target = "_blank", 
        #   tags$img(src = "act-44-early-termination-flow-chart.png", height = "200px", style = "display: block; margin: 40px auto;")
        # ),
        tags$a(
          href = "act-44-early-termination-flow-chart.png",
          target = "_blank",
  ...
  observeEvent(input$answer, {
    ...
    if(length(current_question$question_list) == 0 & length(current_question$date_question) > 0){
      ...
      if(current_question$question_id == "before_june_11_q2"){
        ...
        if(input$answer == "Yes"){
          eligibility_date(as.Date(sentencing_date()) + year(4))
        }else if(input$answer == "No"){
          eligibility_date(as.Date(sentencing_date()) + year(2))
        }
      }
