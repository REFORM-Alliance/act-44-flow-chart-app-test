...
decision_tree <- list(
  ...
  list(
    ...
    # question_list = list(
    #   "q1" = "Earn a high school diploma or GED",
    #   "q2" = "Earn an associate degree from an accredited university, college, seminary college, community college, or two-year college",
    #   "q3" = "Earn a bachelor's degree from an accredited university, college, or seminary college",
    #   "q4" = "Earn a master's or other graduate degree from an accredited university, college, or seminary college",
    #   "q5" = "Obtain a vocational or occupational license, certificate, registration, or permit that was approved by your probation officer", 
    #   "q6" = "Complete a certified vocational, certified technical, or certified career education or training program that was approved by your probation officer", 
    #   "q7" = "Finish a program or condition designed to improve your life that was ordered by the court at sentencing and approved by your probation officer?"
    # ),
    choices = c("Yes", "No"),
  ...
  #   question_id = "section_7_q2_mandate_result"
  # ),
  list(result = 
         tags$div(
...
server <- function(input, output, session){
  ...
  calculate_eligibility_date_prc <- reactive({
    ...
    # Add req() for potentially missing values
    # req(same_conduct_answer(), multiple_misdemeanors(),
    #     probation_after_parole_answer(), final_year_of_parole_answer(),
    #     education_credits_more_than_2_answer())
    
    # same_conduct_val <- req(same_conduct_answer(), default = "N/A")
    # multiple_misdemeanors_val <- req(multiple_misdemeanors(), default = "N/A")
    # probation_after_parole_val <- req(probation_after_parole_answer(), default = "N/A")
    # final_year_of_parole_val <- req(final_year_of_parole_answer(), default = "N/A")
    # education_credits_more_than_2_val <- req(education_credits_more_than_2_answer(), default = "N/A")
  ...
  #   print(paste("final_year_of_parole_answer():", final_year_of_parole_answer()))
  #   
  #   if(!is.null(sentencing_date()) & !is.null(felony_or_misdemeanor()) & !is.null(sentencing_length_year()) & !is.null(sentencing_length_month()) & !is.null(education_credits_answer())){
  #     base_date <- as.Date(sentencing_date())
  #     felony_val <- felony_or_misdemeanor()
  #     sentencing_length_year_val <- as.numeric(sentencing_length_year())
  #     sentencing_length_month_val <- as.numeric(sentencing_length_month())
  ...
  #     if(felony_val == "Felony"){
  #       same_conduct_val <- "NA"
  #       multiple_misdemeanors_val <- "N/A"
  #       if(education_credits_val == "Yes"){
  #         education_credits_more_than_2_val <- education_credits_more_than_2_answer()
  #       }else if(education_credits_val == "No"){
  #         education_credits_more_than_2_val <- "N/A"
  #       }
  #       probation_after_parole_val <- probation_after_parole_answer()
  #       if(probation_after_parole_val == "Yes"){
  #         final_year_of_parole_val <- final_year_of_parole_answer()
  #       }else if(probation_after_parole_val == "No"){
  #         final_year_of_parole_val <- "N/A"
  #       }
  #     }else if(felony_val == "Misdemeanor"){
  #       multiple_misdemeanors_val <- multiple_misdemeanors()
  #       if(multiple_misdemeanors_val == "Yes"){
  #         same_conduct_val <- same_conduct_answer()
  #         if(same_conduct_val == "Different Conduct" & education_credits_val == "Yes"){
  #           education_credits_more_than_2_val = education_credits_more_than_2_answer()
  #         }else{
  #           education_credits_more_than_2_val = "NA"
  #         }
  #       }else if(multiple_misdemeanors_val == "No"){
  #         same_conduct_val <- "N/A"
  #       }
  #       education_credits_more_than_2_val <- "N/A"
  #       probation_after_parole_val = "N/A"
  #       final_year_of_parole_val = "N/A"
  #     }
  #     
  #     misdemeanor_potential_date <- base_date + years(2)
  ...
  #   same_conduct_val <- same_conduct_answer()
  #   multiple_misdemeanors_val <- multiple_misdemeanors()
  #   sentencing_length_val <- as.numeric(sentencing_length())
  #   education_credits_val <- education_credits_answer()
  #   education_credits_more_than_2_val <- education_credits_more_than_2_answer()
  #   probation_after_parole_val <- probation_after_parole_answer()
  #   final_year_of_parole_val <- final_year_of_parole_answer()
  # 
  #   # Check for essential NULLs
  #   if(is.null(base_date) || is.null(felony_val) || is.null(sentencing_length_val)) {
  #     print("Early return due to essential NULLs")
  #     return(NULL)
  #   }
  # 
  #   misdemeanor_potential_date <- base_date + years(2)
  #   half_sentence <- base_date + months(as.numeric(sentencing_length_val)/2)
  #   felony_potential_date <- base_date + years(4)
  #   one_year_after_sentence_date <- base_date + years(1)
  #   eligibility_date_val <- NULL
  # 
  #   print("Checking first if condition...")
  #   print(paste("Condition:", felony_val == "Misdemeanor" && (is.null(multiple_misdemeanors_val) || multiple_misdemeanors_val == "No" || (same_conduct_val != "Same Conduct" && multiple_misdemeanors_val == "Yes"))))
  #   print(paste("Length:", length(felony_val == "Misdemeanor" && (is.null(multiple_misdemeanors_val) || multiple_misdemeanors_val == "No" || (same_conduct_val != "Same Conduct" && multiple_misdemeanors_val == "Yes")))))
  #   if(felony_val == "Misdemeanor" && (is.null(multiple_misdemeanors_val) || multiple_misdemeanors_val == "No" || (same_conduct_val != "Same Conduct" && multiple_misdemeanors_val == "Yes"))) {
  #     eligibility_date_val <- min(misdemeanor_potential_date, half_sentence)
  #     if(!is.null(education_credits_val) && education_credits_val == "Yes") {
  #       eligibility_date_val <- eligibility_date_val - months(6)
  #     }
  #   }else if(felony_val == "Felony" || (felony_val == "Misdemeanor" && !is.null(multiple_misdemeanors_val) && multiple_misdemeanors_val == "Yes" && same_conduct_val == "Different Conduct")) {
  #     print("Checking second if condition...")
  #     print(paste("Condition:", felony_val == "Felony" || (felony_val == "Misdemeanor" && !is.null(multiple_misdemeanors_val) && multiple_misdemeanors_val == "Yes" && same_conduct_val == "Different Conduct")))
  #     print(paste("Length:", length(felony_val == "Felony" || (felony_val == "Misdemeanor" && !is.null(multiple_misdemeanors_val) && multiple_misdemeanors_val == "Yes" && same_conduct_val == "Different Conduct"))))
  #     eligibility_date_val <- min(felony_potential_date, half_sentence)
  #     if(!is.null(education_credits_val) && education_credits_val == "Yes") {
  #       eligibility_date_val <- eligibility_date_val - months(6)
  #       if(!is.null(education_credits_more_than_2_val) && education_credits_more_than_2_val == "Yes") {
  #         eligibility_date_val <- eligibility_date_val - months(6)
  #       }
  #     }
  #     if(!is.null(probation_after_parole_val) && probation_after_parole_val == "Yes" && !is.null(final_year_of_parole_val) && final_year_of_parole_val == "Yes") {
  #       eligibility_date_val <- eligibility_date_val - months(12)
  #     }
  #   }
  # 
  #   if(!is.null(eligibility_date_val)) {
  #     print("Checking final if condition...")
  #     print(paste("Condition:", !is.null(eligibility_date_val)))
  #     print(paste("Length:", length(!is.null(eligibility_date_val))))
  #     eligibility_date_final <- max(eligibility_date_val, one_year_after_sentence_date)
  #     return(eligibility_date_final)
  #   }else{
  ...
  render_prc_flow_q9 <- reactive({
    ...
    if(!is.null(eligibility_date_val)){
      tagList(
        ...
        radioButtons("answer", NULL, choices = c("Yes", "No"))
      )
    }else{
      tags$p("Calculating eligibility date...")
    }
  ...
  # all_prc_data_available <- reactive({
  #   !is.null(sentencing_date()) &&
  #     !is.null(felony_or_misdemeanor()) &&
  #     !is.null(sentencing_length_year()) &&
  #     !is.null(sentencing_length_month()) &&
  #     !is.null(education_credits_answer())
  #   # Add any other reactive values needed for the calculation
  #   # that must be checked here
  # })
  # 
  # get_prc_data <- reactive({
  #   list(
  #     sentencing_date = sentencing_date(),
  #     felony_or_misdemeanor = felony_or_misdemeanor(),
  #     sentencing_length_month = sentencing_length_month(),
  #     sentencing_length_year = sentencing_length_year(),
  #     education_credits_answer = education_credits_answer()
  #   )
  # })
  # 
  # # Reactive function to calculate eligibility date (only the calculation logic)
  # calculate_eligibility_date_prc_logic <- reactive({
  #   req(all_prc_data_available())
  #   
  #   base_date <- as.Date(sentencing_date())
  #   felony_val <- felony_or_misdemeanor()
  #   same_conduct_val <- same_conduct_answer()
  ...
  #   final_year_of_parole_val <- final_year_of_parole_answer()
  #   
  #   # (Your calculation logic here, without the initial NULL checks)
  #   # Since all inputs are guaranteed to be non-NULL by now,
  #   # you can simplify the logic slightly
  #   sentencing_length_val <- as.numeric(sentencing_length_month_val + (12 * sentencing_length_year_val))
  #   misdemeanor_potential_date <- base_date + years(2)
  #   if(sentencing_length_val%%2 == 1){
  #     half_sentence <- base_date + months((sentencing_length_val - 1) / 2) + days(15)
  ...
  #   
  #   eligibility_date_final <- as.Date(max(c(eligibility_date_val, one_year_after_sentence_date)))
  #   if(is.null(eligibility_date_val) == TRUE){
  #     eligibility_date_final = NULL
  #   }
  #   return(eligibility_date_final)
  # })
  
  # # observeEvent to trigger calculation when data is available
  # observeEvent(all_prc_data_available(), {
  #   prc_data <- get_prc_data()  # Get the current data
  #   
  #   print("Current PRC Data:")
  #   print(prc_data)
  # 
  #   if (all_prc_data_available()) {
  #     eligibility_date_prc(calculate_eligibility_date_prc_logic())
  #     print("PRC eligibility date calculated!")
  #   } else {
  #     eligibility_date_prc(NULL)
  #     print("PRC data not yet available")
  #   }
  #   
  #   # You can also print individual values if needed
  #   print(paste("Sentencing Date:", prc_data$sentencing_date))
  #   print(paste("Felony/Misdemeanor:", prc_data$felony_or_misdemeanor))
  #   print(paste("Sentencing Length Year:", prc_data$sentencing_length_year))
  #   print(paste("Sentencing Length Month:", prc_data$sentencing_length_month))
  #   print(paste("Education Credits:", prc_data$education_credits_answer))
  #   
  # }, ignoreNULL = FALSE)
  ...
  observeEvent(input$answer, {
    ...
    if(length(current_question$question_list) == 0 & length(current_question$date_question) > 0){
      ...
      # else if(current_question$question_id == "prc_flow_q4"){
      #   years = reactive({input$answer_years})
      #   months = reactive({input$answer_months})
      #   # months = input$year
  ...
  observe({
    # current_index <- tail(history(), 1)
    # current_question <- decision_tree[[current_index]]
    # if(current_question$question_id == "prc_flow_q7"){
    #   eligibility_date_prc(calculate_eligibility_date_prc_logic())
    # }
  ...
  observeEvent(input$answer_years, {
    sentencing_length_year(as.numeric(input$answer_years))
    # print(paste("Year selected:", input$answer_years)) # For debugging
    # print(paste("Year selected reactive:", sentencing_length_year()))
  })
  
  observeEvent(input$answer_months, {
    sentencing_length_month(as.numeric(input$answer_months))
    # print(paste("Month selected:", input$answer_months)) # For debugging
    # print(paste("Month selected reactive:", sentencing_length_month()))
  })
    ...
    if("choices" %in% names(current_question)){
      if(length(current_question$question_list) == 0){
        if(current_question$question_id == "section_7_q3"){
          ...
          # if(education_credits_val == "No" | felony_or_misdemeanor_val == "Misdemeanor"){
          #   next_id <- current_question$next_question[["No"]]
          # }else if(education_credits_val == "Yes" & felony_or_misdemeanor_val == "Felony"){
          #   next_id <- current_question$next_question[["Yes"]]
          # }
        }else{
